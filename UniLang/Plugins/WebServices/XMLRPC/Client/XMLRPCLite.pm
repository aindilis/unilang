package UniLang::Plugins::WebServices::XMLRPC::Client::XMLRPCLite;

use base qw(UniLang::Plugins::WebServices::XMLRPC::Client);
...
sub init {
  ...
  UniLang::Plugins::WebServices::XMLRPC::Client->init(%args);
}
...
sub WSQueryAgent {
  ...
  #     ref $response->{Message} eq "UniLang::Util::Message") {
